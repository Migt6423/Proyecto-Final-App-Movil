...
class AdminPaginaUbicacion extends StatefulWidget {
  const AdminPaginaUbicacion({Key? key}) : super(key: key);

  @override
  _AdminPaginaUbicacionState createState() => _AdminPaginaUbicacionState();
}

class _AdminPaginaUbicacionState extends State<AdminPaginaUbicacion> {
...
class _AdminPaginaUbicacionState extends State<AdminPaginaUbicacion> {
  ...
  void initState() {
    super.initState();
    _currentLocation = LatLng(0.0, 0.0); // Asigna una ubicación inicial
    _loadMarkers();
  }
